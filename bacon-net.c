...
extern BaconBoolean      g_show_progress;
static BaconNetInstance *s_net       = NULL;
#ifdef BACON_GTK
static BaconBoolean      s_for_icons = BACON_FALSE;
#endif
...
static void
bacon_net_init (BaconNetAction action, unsigned long offset, const char *loc)
{
